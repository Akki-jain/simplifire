...
<html lang="en">
  ...
  <head>
    ...
    <title>Simplifire | Conferences</title>
...
<table cellspacing="10px" cellpadding="8px" style=" margin-left:-40px; margin-right:40px;">
<?php
  ...
  <tr>
    ...
    ?>
  <tr>
    <th  style="width: 130px; text-align:center;" class="datalooks">Organized By</th>
    <th  style="width: 90px; text-align:center;" class="datalooks">Name</th>
    <th  style="width: 130px; text-align:center;" class="datalooks">Start Date</th>
    <th  style="width: 130px; text-align:center;" class="datalooks">End Date</th>
    <th  style="width: 90px; text-align:center;" class="datalooks">Role</th>
    <th  style="width: 130px; text-align:center;" class="datalooks">Institute</th>
    <th  style="width: 130px; text-align:center;" class="datalooks">Duration</th>
    <th  style="width: 80px; text-align:center;" class="datalooks">URL</th>
    <th  style="width: 130px; text-align:center;" class="datalooks">Type</th>
    <th  style="width: 130px; text-align:center;" class="datalooks">Level</th>
...
<form method="post" action="export.php" style="">
...
<button class="button1" onclick="openForm()" style="">Generate PDF</button>

  <div class="form-popup" id="myForm">
    <form method="POST" action="generate_pdf.php" class="form-container">
      <h1 style="color:#000000;">Give your Input</h1>

      <label for="email"><b style="color:#000000;">Highlights</b></label>
      <input type="text" placeholder="Enter Highlights" name="highlights" required>
      <input type="hidden" name="hidden1" value="<?php echo $table??'';?>" /> 
